...
$(function () {
  ...
  function renderTables() {
    $('table:not(.table-landing)').addClass('table table-bordered table-striped table-condensed');    
  }
  ...
  function renderSidebar() {
    ...
    if (typeof (sidetoc) === 'undefined') {
      ...
      // Let's keep the sidebar expanded for now while it's small
      $('.toc .nav > li').addClass(expanded);
